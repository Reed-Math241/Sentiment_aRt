...
ggplot(data = book_coords_7deg, mapping = aes(x = x_coord, y = y_coord, color = color_val)) +
  geom_point(size = .1) +
  scale_color_continuous(low = "dark red", high = "white") +
...
ggplot(data = feather_sample1, mapping = aes(x = x_coord, y = y_coord, color = "red")) +
  geom_point() +
  geom_point(data = feather_sample2) +
  geom_point(data = feather_sample3) +
  geom_point(data = feather_sample4) +
  geom_point(data = feather_sample5) +
  theme(line = element_blank(),
        text = element_blank(),
        title = element_blank(),
        panel.background = element_rect(fill = "black",
