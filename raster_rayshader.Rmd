...
range <- 5 #depth of the neighborhood 
thresold <- 29 #cell limit
states <- 5 #maximum number of states allowed (algorithm M) 
neighborhood <- "M" #pattern of neighboring cells
